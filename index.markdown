...
<div style="float: right; width: 65%;">
    ...
    I am interested in bridging the gap between surgical robot and robot learning. My research goal is to develop an AI surgeon capable of autonomously performing long-horizon surgical tasks.
    <br>
    <br>
    <div style="text-align: center;">
        &nbsp; <i class="fa fa-file"></i> <a href="https://drive.google.com/file/d/1SQVhCcfgb9iKXyxISwsxIiJxIP1ey0BI/view?usp=sharing">&nbsp; CV</a> &nbsp; |
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="20">
    <tr>
        ...
        <ul>
            <li><strong>[Sep, 2023]</strong> &nbsp;One paper accepted to 2023 AAAI Fall Symposium.</li>
        </ul>
    </tr>
</table>
